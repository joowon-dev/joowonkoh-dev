...
description: "Model Context Protocol(MCP) 서버를 직접 만드는 과정을 정리한다. Supabase MCP 구조를 분석하고, TypeScript SDK로 간단한 서버를 만들어 Claude Code에 연결하는 전체 흐름이다."
date: "2026-04-12"
tags: ["Dev", "Claude Code", "MCP"]
---
