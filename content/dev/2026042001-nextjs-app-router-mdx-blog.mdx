...
description: "App Router로 MDX 블로그를 만들면서 부딪힌 함정 6가지를 정리한다. generateStaticParams, dynamic route, 메타데이터, Pages Router 가이드와의 차이, 빌드 타임 vs 런타임."
date: "2026-04-20"
tags: ["Dev", "Next.js", "MDX"]
---
