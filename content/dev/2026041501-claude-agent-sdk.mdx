...
description: "Claude Agent SDK는 Claude Code의 엔진을 그대로 빌려쓸 수 있게 한 라이브러리다. 도구, 권한, 스트리밍을 직접 제어하는 자체 CLI 에이전트를 100줄 이내로 만드는 과정을 정리한다."
date: "2026-04-15"
tags: ["Dev", "Claude API", "Agent SDK"]
---
