...
![셸을 바꿨다가 다시 돌아온 과정을 나타낸 일러스트](/blog/2026041702-zsh-to-fish-and-back/hero.jpg)
...
## 직접 겪은 일: 돌아온 zsh는 17줄이다

돌아왔다고 썼으니 돌아온 자리가 어떤지도 적어두는 게 맞겠다. 지금 내 `.zshrc`는 **17줄**이다.

들어 있는 건 거의 전부 경로 설정이다. nvm, rbenv, bun, 그리고 예전에 쓰던 rvm 경로가 아직 한 줄 남아 있다. 프롬프트를 꾸미는 줄도, 플러그인 매니저도 없다.

fish를 떠난 이유를 다시 생각해 보면 여기에 답이 있다. fish의 장점은 **기본값이 좋다**는 것이었는데, 나는 결국 셸에 아무것도 안 하고 싶었던 사람이었다. 기본값이 좋은 셸과 아무것도 안 깐 셸은 겉보기에 비슷한 자리에 도착한다.

대신 자동완성과 히스토리 검색은 확실히 아쉽다. 그건 fish 쪽이 나았다. 다만 그 아쉬움의 크기가, 스크립트 문법이 다른 데서 오는 잔고장보다는 작았다.

**셸을 고르는 일은 기능 비교가 아니라 «내가 셸을 얼마나 만질 사람인가»를 정하는 일**이었다. 그걸 모른 채로 옮겼다가 돌아온 셈이다.
