...
description: "PreToolUse, PostToolUse, SessionStart, UserPromptSubmit. Claude Code의 Hooks 시스템으로 매일 반복하던 작업을 자동화한 7가지 패턴을 settings.json 예시와 함께 정리한다."
date: "2026-04-13"
tags: ["Dev", "Claude Code", "자동화"]
---
