...
/**
 * 세션 없이 접근할 수 있는 어드민 경로.
 *
 * /admin/denied는 일부러 넣지 않았다. 그 페이지는 "로그인은 했지만 허용목록에
 * 없는 사용자"에게 보여주는 것이고, 그런 사용자는 세션이 있으므로 여기서 걸리지
 * 않는다. 로그아웃 상태로 직접 찾아온 사람에게 거부 화면을 보여줄 이유는 없다.
 */
