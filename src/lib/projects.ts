...
export const projects: Project[] = [
  ...
  },
  {
    ...
    tile: ["#dbe7ff", "#ffd6e8"],
    blurb:
      "구글 타임라인을 내려받아 두 사람 것을 한 지도에 겹쳐 재생합니다. 방문 기록은 «14시부터 16시까지 여기 있었다»를 좌표 하나로 적어서, 시작 시각만 읽으면 그 두 시간이 «모르는 구간»이 됩니다 — 종료 시각까지 아는 시간으로 붙여 둡니다. 기록이 30분 넘게 비면 잇지 않습니다 — 이으면 서울에서 부산까지 직선이 그어지고 그 선이 상대를 스쳐 없던 만남이 생깁니다. 파일은 이 기기를 벗어나지 않습니다.",
  },
];
