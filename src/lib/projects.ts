...
export const projects: Project[] = [
  ...
  {
    title: "불꽃놀이",
    description: "주먹을 쥐었다 펴면 손바닥에서 불꽃이 솟습니다 🎆",
    tags: ["Camera", "MediaPipe", "Canvas"],
    href: "/playground/hand-fireworks",
    icon: "firework",
    tile: ["#151c3d", "#060811"],
    blurb:
      "서울세계불꽃축제 날 만들었습니다. 웹캠 앞에서 주먹을 꽉 쥐었다 활짝 펴면 그 손바닥에서 불꽃탄이 솟아오르고 정점에서 터집니다. 손을 높이 들수록 높이 올라갑니다. 펼침도는 손가락 끝과 손목의 거리를 손바닥 길이로 나눠서 재기 때문에 카메라와의 거리가 바뀌어도 같은 값이 나오고, 여닫는 문턱을 둘로 나눠 두어 반쯤 편 손이 떨리는 것만으로는 안 나갑니다. 폭발은 국화·고리·버들가지 세 모양이고 중력과 항력은 라이브러리 없이 직접 적분합니다. 손 모양만 볼 뿐 얼굴도 신원도 다루지 않고, 영상은 브라우저 밖으로 나가지 않습니다.",
  },
];
