...
export const SCREEN = {
   ...
   * 26m는 22m 스크린을 가진 GT 상영관의 뒤쪽 좌석에 해당한다.
   *
   * 여기서 나오는 호는 48.5°, 좌우 끝이 중앙보다 2.3m 앞으로 나온다.
   * 우리가 흔히 가는 디지털 IMAX(1.90:1)는 이보다 훨씬 평평하고,
   * 반대로 진짜 깊게 휜 것은 반구형인 IMAX Dome이다. 이 페이지는 그 사이,
   * 필름 GT 규격을 잡았다.
   */
  radius: 26,
  /**
