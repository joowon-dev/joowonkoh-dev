...
const STEPS: { title: string; body: string }[] = [
  ...
  },
  {
    ...
    body: "Dock에는 아이콘이 없습니다. 최고 비거리도, 종료도 이 메뉴에서 합니다. 손쉬운 사용 같은 권한은 하나도 요구하지 않습니다. 유니폼도 여기서 고릅니다 — KBO 10개 구단의 홈·원정을 타자와 투수에게 따로 입힐 수 있고, 모니터가 여러 대면 어느 화면에 띄울지도 고릅니다.",
  },
  {
