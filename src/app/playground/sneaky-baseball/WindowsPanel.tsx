...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    body: "윈도우 11은 새 아이콘을 기본으로 숨깁니다. 시계 옆 ^ 를 눌러 꺼내서 작업 표시줄에 고정하세요. 최고 비거리도, 종료도 이 메뉴에서 합니다. 유니폼도 여기서 고릅니다 — 처음엔 롯데를 입고 나오고, KBO 10개 구단의 홈·원정을 타자와 투수에게 따로 입힐 수 있습니다. 모니터가 여러 대면 어느 화면에 띄울지도 고릅니다.",
  },
  {
