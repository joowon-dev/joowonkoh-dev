...
/**
 * 그날 둘이 함께 걷는 코스 — 성수동 골목과 서울숲을 도는 한 바퀴.
 *
 * 전부 한강 북쪽 성수동 안에 둔다. 점과 점 사이는 직선으로 이어지므로,
 * 강 건너 지점을 하나라도 섞으면 두 사람이 물 위를 가로질러 걷는 그림이 된다
 * (뚝섬유원지와 청담대교를 넣었다가 실제로 한강 위를 떠다녔다).
 * 아래 좌표는 모두 위도 37.54~37.548, 경도 127.037~127.056 안에 있다.
 */
const DENSE_WALK: LatLon[] = [
  { lat: 37.5447, lon: 127.0557 }, // 성수역
  { lat: 37.5432, lon: 127.0533 }, // 연무장길
  { lat: 37.5421, lon: 127.0505 }, // 성수동 카페 골목
  { lat: 37.5440, lon: 127.0478 }, // 뚝섬역 방향
  { lat: 37.5468, lon: 127.0452 }, // 언더스탠드에비뉴
  { lat: 37.5455, lon: 127.0402 }, // 서울숲 입구
  { lat: 37.5437, lon: 127.0378 }, // 서울숲 안쪽
  { lat: 37.5462, lon: 127.0421 }, // 서울숲 북측 산책로
  { lat: 37.5474, lon: 127.0492 }, // 뚝섬역
  { lat: 37.5447, lon: 127.0557 }, // 성수역으로 돌아온다
];
